module.exports = (obj) => {
  ...
  <head>
    ...
    <style type="text/css">
    <!--
    div.bg { background: url("` + __dirname + '/assets/background.jpg' + `") no-repeat; background-size: contain;}
    ...
    td.cls_008{font-family:"Roboto", Arial, Helvetica, sans-serif,serif;font-size:30px;color:rgb(43,42,41);font-weight:bold;font-style:normal;text-decoration: none}
    -->
    </style>
  </head>
  <body>
    <div class="bg" style="position:absolute;left:50%;margin-left:-336px;top:0px;width:672px;height:950px;overflow:hidden;">
        ...
        <tr>
          <td>
            <table style="width:100%;">
              ...
              <tr>
                <td colspan="2">
                  <table style="width:200px; padding-left: 40px;">
                    <tr>
                ...
                <td>
                  <table>
                    ...
                    <tr>
                      <td class="cls_005"><span class="cls_004">Geldig tot:</span> : (XX-XXXXXX)</td>
                    </tr>
                  </table>
                </td>
              </tr>
